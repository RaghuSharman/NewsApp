...
//            Text(text = newsData.publishedAt, )
        ...
        Text(text = newsData.title,modifier = Modifier.padding(start = 10.dp, end = 10.dp, top = 10.dp), fontWeight = FontWeight.Bold)
        Text(text = newsData.description,modifier = Modifier.padding(start = 10.dp, end = 10.dp, top = 10.dp), fontWeight = FontWeight.Light)
    }
}
...
fun InfoWithIcon(icon: ImageVector, info: String){
    ...
    Row {
        Icon(icon, contentDescription = "Author", modifier = Modifier.padding(start = 8.dp, end = 8.dp),
